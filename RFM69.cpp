...
bool RFM69::initialize(uint8_t freqBand, uint8_t nodeID, uint8_t networkID)
{
  const uint8_t CONFIG[][2] =
  {
    ...
    /* 0x05 */ { REG_FDEVMSB, RF_FDEVMSB_4500}, // default: 5KHz, (FDEV + BitRate / 2 <= 500KHz)
    /* 0x06 */ { REG_FDEVLSB, RF_FDEVLSB_4500},
    ...
    /* 0x38 */ { REG_PAYLOADLENGTH, 0x00 }, // 0: unlimited packet format
